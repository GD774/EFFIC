...
<body>
  <div class="min-h-screen overflow-auto">
   ...
   <td data-modal-target="static-modal" data-modal-toggle="static-modal"
	 class="ease relative h-16 cursor-pointer border border-stroke p-1 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-20 md:p-3 xl:h-24">
