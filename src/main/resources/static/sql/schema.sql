...
VALUES ('tester1', STANDARD_HASH('1111', 'SHA256'), '안성기', 1, 0, 1, '001', TO_DATE('2023-01-01', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester2', STANDARD_HASH('1111', 'SHA256'), '신해철', 1, 0, 1, '002', TO_DATE('2023-02-01', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester3', STANDARD_HASH('1111', 'SHA256'), '신혜선', 1, 1, 1, '003', TO_DATE('2023-03-01', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester4', STANDARD_HASH('1111', 'SHA256'), '구혜선', 1, 1, 1, '004', TO_DATE('2023-04-01', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('testser', STANDARD_HASH('1111', 'SHA256'), '박소담', 1, 1, 1, '005', TO_DATE('2023-05-01', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester6', STANDARD_HASH('1111', 'SHA256'), '조준영', 1, 0, 2, '001', TO_DATE('2023-01-15', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester7', STANDARD_HASH('1111', 'SHA256'), '남민우', 1, 0, 2, '003', TO_DATE('2023-01-15', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester8', STANDARD_HASH('1111', 'SHA256'), '박화평', 1, 0, 2, '002', TO_DATE('2023-01-15', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester9', STANDARD_HASH('1111', 'SHA256'), '전지현', 1, 1, 2, '001', TO_DATE('2023-01-15', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester10', STANDARD_HASH('1111', 'SHA256'), '김지은', 1, 1, 2, '004', TO_DATE('2023-01-15', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester11', STANDARD_HASH('1111', 'SHA256'), '주윤발', 1, 0, '3', '003', TO_DATE('2020-01-01', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester12', STANDARD_HASH('1111', 'SHA256'), '고길동', 1, 0, '3', '002', TO_DATE('2022-03-05', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester13', STANDARD_HASH('1111', 'SHA256'), '나무늬', 1, 1, '3', '003', TO_DATE('2024-02-07', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester14', STANDARD_HASH('1111', 'SHA256'), '양희은', 1, 1, '3', '001', TO_DATE('2021-11-18', 'YYYY-MM-DD'), NULL);
INSERT INTO USER_T (EMP_ID, PASSWORD, NAME, STATUS, GENDER_ID, DEP_ID, POS_ID, JOIN_DT, LEAVE_DT)
VALUES ('tester15', STANDARD_HASH('1111', 'SHA256'), '신성우', 1, 0, '3', '002', TO_DATE('2023-07-16', 'YYYY-MM-DD'), NULL);
