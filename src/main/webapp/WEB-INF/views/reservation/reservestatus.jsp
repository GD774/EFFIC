            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  <li>
                    <a class="font-medium" href="index.html">메인 /</a>
                  </li>
    ...
    <tbody>
      ...
      <tr class="grid grid-cols-8">
        <td class="ease relative h-16 cursor-pointer border border-stroke p-1 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-20 md:p-3 xl:h-24">
          <span class="font-medium text-black dark:text-white">1층 소회의실</span>
        </td>
        <td class="ease relative h-16 cursor-pointer border border-stroke p-1 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-20 md:p-3 xl:h-24">
       ...
       <td class="ease relative h-16 cursor-pointer border border-stroke p-1 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-20 md:p-3 xl:h-24">
        ...
        <main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              <h4 class="text-title-md2 font-bold text-black dark:text-white">
                회의실 예약 현황
              </h4>
            </div>
            <!-- Breadcrumb End -->
