    ...
    <span class="mx-auto mb-6 inline-block h-1 w-22.5 rounded bg-primary"></span>
     <div id="jstree">
      ...
      <div class="w-full px-3 2xsm:w-1/2">
        <button @click="modalOpen = false"  class="ml-20 mt-4 block w-full rounded border border-stroke bg-gray p-3 text-center font-medium text-black transition hover:border-meta-1 hover:bg-meta-1 hover:text-white dark:border-strokedark dark:bg-meta-4 dark:text-white dark:hover:border-meta-1 dark:hover:bg-meta-1">
          닫 기
        </button>
    </div>
  </div>
