                    ...
                    <div class="p-6.5">
                      ...
                      <div class="mb-5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="flex items-center">
                          ...
                          <input type="text" placeholder="Enter your first name" class="ml-50 w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                          </div>
