                ...
                <li>
                  ...
                  <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6"
                    ...
                    <li>
                      <a
                        class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                        href="${contextPath}/approval/mySaveDocList"
                        :class="page === 'formElements' && '!text-white'"
                      >임시저장함</a>
                    </li>
                    <li>
...
@click="selected = (selected === 'Messages' ? '':'Messages')"
          ...
          <li>
			<a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="#"
              @click="selected = (selected === 'Manage' ? '':'Manage')"
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Manage') && (page === 'manage') }"
              >
			  <svg
                class="fill-current"
                width="18"
			  ...
			  <svg
				class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
				:class="{ 'rotate-180': (selected === 'Manage') }"
				width="20"
				height="20"
				viewBox="0 0 20 20"
				fill="none"
			...
			<div
              ...
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
				<li>
                  <a
					class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
					href="${contextPath}/admin/userlist"
					:class="page === 'formElements' && '!text-white'"
					>사원 목록</a
								  >
				</li>
          ...
          <li>
			<a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="${contextPath}/signout"
              @click="selected = (selected === 'Signout' ? '':'Signout')"
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Signout') && (page === 'signout') }"
              :class="page === 'signout' && 'bg-graydark'"
              >
			  <svg
                class="fill-current"
                width="18"
