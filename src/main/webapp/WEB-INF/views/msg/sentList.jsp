...
const fnGetMsgList = () => {
       ...
       $.ajax({
		  ...
		  success: (resData) => {
		    	...
		    	let str=  '<div data-msg-id="'+msg.msgId+'" class="msg-detail hover:bg-gray grid grid-cols-11 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11 hover:opacity-20" style="grid-template-columns: 50px 50px repeat(9, 1fr);">';
		    	...
		    	str += '<div class="col-span-2"> <p class="text-[#637381] dark:text-bodydark"> '+ msg.recipient +' </p></div>';
